...
public class Move {
    ...
    /**
     * Construtor for the Move object
     *
     * @param   p   the piece whose moves are to be found out
     * @param   ix  the initial x coordinate of the move
     * @param   iy  the initial y coordinate of the move
     * @param   fi  the final   x coordinate of the move
     * @param   fy  the final   y coordinate of the move
     * @param   b   true, if the move object involves eliminating one of the pieces of the opponent's piece
     *
     **/
...
// MUTATOR methods
    ...
    /**
     * checks whether a piece can move from start to end vertically(for Rook and queen)
     *
     * @return  true if the there is no piece is present between the initial and final coordinates of a move,
     *          true if there is a piece at the final coordinates of the move if the above condition holds true
     *          only for moves where the initial and final x Coordinates are the same
     * */

    public boolean straightLineCheckVertical() {

        // if the initialX and finalX are different or if the final coordinates are out of range, or initialX == finalX  return false
    ...
    /**
     * checking the validity of a diagonal move for bishop and queen
     *
