 ...
 *
 * @author  Eeshan Jaiswal  created 2/5/2018
 * */
public class TextDisplay implements Display {
    private Board  currentBoard;
    private char[][] boardToDisplay ;// the board displayed
    ...
    /**
    *
    * Displays the pieces of both the players on the board
    * */
        ...
        for(int blackIterator = 0 ; blackIterator<black.getNumPieces() ; blackIterator++){
          ...
          for (int row=7; row >= 0 ;row-- ) {
                for (int col = 7 ; col>=0 ; col--) {
                    ...
                    tempArray[tempPiece.getX()][tempPiece.getY()] = tempPiece.getChar();
                    //why are negative values created
                }
          }
        }
    ...
    /**
     * returns true if the length of the coordinates are valid, the coordinates are not out of bounds
     *@param    s   the coordinates to be checked
