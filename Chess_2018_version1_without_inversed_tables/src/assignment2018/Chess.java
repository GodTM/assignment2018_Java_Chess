...
public class Chess{
    ...
    public Chess(){
        ...
        if(potentialOpponent.equalsIgnoreCase("r")){
            if(colorOfPiecesOfUser.equalsIgnoreCase("W")) {
                this.player2 = new RandomPlayer("Random Computer",board.getBlackPieces() ,this.board,this.humanPlayer);
            }
            else if(colorOfPiecesOfUser.equalsIgnoreCase("B")){
                this.player2 = new RandomPlayer("Random Computer",board.getWhitePieces() ,this.board,this.humanPlayer);
            }
        }
        else if(potentialOpponent.equalsIgnoreCase("a")){

            if(colorOfPiecesOfUser.equalsIgnoreCase("W")) {
                this.player2 = new AggressivePlayer("Aggressive Computer",board.getBlackPieces() ,this.board,this.humanPlayer);
            }
            else if(colorOfPiecesOfUser.equalsIgnoreCase("B")){
                this.player2 = new AggressivePlayer("Aggressive Computer",board.getWhitePieces() ,this.board,this.humanPlayer);
            }
        }
            ...
            if(colorOfPiecesOfUser.equalsIgnoreCase("W")) {
                this.player2 = new HumanPlayer(opponentName,board.getBlackPieces() ,this.board,this.humanPlayer) ;
            }
            else if(colorOfPiecesOfUser.equalsIgnoreCase("B")){
                this.player2 = new HumanPlayer(opponentName,board.getWhitePieces() ,this.board,this.humanPlayer) ;
            }
        }
    ...
    public void run() {
        ...
        while (firstKingPresent && secondKingPresent) {
