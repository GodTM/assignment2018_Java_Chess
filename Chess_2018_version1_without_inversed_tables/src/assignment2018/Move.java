...
// MUTATOR methods
    ...
    /**
     * @param   int initialX    the initial x coordinate of a Move Object
     * */
    ...
    /**
     * @param   int finalX      the final x coordinate of the Move object
     * */
    ...
    /**
     *@param    int initialY    the initial Y coordinate of the Move Object
     * */
    ...
    /**
     *@param    int finalY      the final Y coordinate of the Move object
     * */
    ...
    /**
     * @param   boolean occupied    sets the occupied to true/false
     * */
        ...
        // if the final coordinates are in the range and initialY != finalY
            ...
            if (this.initialY < this.finalY) {
                while (!verticalSearchTrue) {
                    ...
                    if(this.p.getBoard().occupied(this.initialX, tempYCoord) && tempYCoord != this.getFinalY()){
        ...
        // if the final coordinates are in the range and initialX != finalX
            ...
            if (this.getInitialX() < this.getFinalX()) {
                while (!horizontalSearchTrue) {
                    ...
                    if(this.p.getBoard().occupied(tempXCoord,this.getInitialY()) && tempXCoord != this.getFinalX()){
        ...
        if (this.p.getBoard().outOfRange(this.getFinalX(), this.getFinalY())|| (this.getInitialY()==this.getFinalY()) ||(this.getInitialX() == this.getFinalX())) {
            ...
            if ((this.getInitialX() < this.getFinalX()) && (this.getInitialY() < this.getFinalY())) {
                while (!diagonalTrue) {
                    startX += 1;
                    startY += 1;
                    int tempXCoord = this.getInitialX()+startX ;
                    int tempYCoord = this.getInitialY()+startY ;
                    //will turn false if the next diagonally top-right box is occupied

                    if(this.p.getBoard().occupied(tempXCoord, tempYCoord) && (tempXCoord!= this.getFinalX() || tempYCoord!=this.getFinalY())){
                        diagonalTrue = false ;
                        break ;
                    }
                    ...
                    if ((tempXCoord == this.getFinalX()) && (tempYCoord == this.getFinalY()) && (this.p.getColour()!= p.getBoard().getPiece(tempXCoord, tempYCoord).getColour()) && (this.p.getBoard().occupied(tempXCoord, tempYCoord))) {
                        diagonalTrue = true;
                        oppAtFinalCoords = true;
                    }
                    else if ((tempXCoord == this.getFinalX()) && (tempYCoord == this.getFinalY()) && (this.p.getColour() == p.getBoard().getPiece(tempXCoord,tempYCoord).getColour()) && (this.p.getBoard().occupied(tempXCoord,tempYCoord))) {
                            diagonalTrue = false;
                            oppAtFinalCoords = false;
                            break;
                    }
            ...
            // move towards bottom -right direction
                ...
                while (!diagonalTrue) {
                    ...
                    if(this.getFinalY()!= tempYCoord && this.getFinalX()!= tempXCoord && this.getP().getBoard().occupied(tempXCoord,tempYCoord)){
                        diagonalTrue = false ;
                        break ;
            ...
            // move towards top -left direction
                ...
                while (!diagonalTrue) {
                    ...
                    //will turn false if the next diagonally top-right box is occupied
                    diagonalTrue = (this.p.getBoard().occupied(tempXCoord, tempYCoord ));
                    // if the path is clear till the final coordinates check whether the destination coordinates are occupied or not
                    //if occupied, check the color of the piece, if same color return false, if different color - true
                    if ((tempXCoord == this.getFinalX()) && tempYCoord == this.getFinalY() && (this.p.getColour() != p.getBoard().getPiece(tempXCoord, tempYCoord).getColour()) && (this.p.getBoard().occupied(tempXCoord, tempYCoord))) {
                        diagonalTrue = true;
